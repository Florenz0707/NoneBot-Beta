...
async def get_steam_users_info(
    ...
    for api_key in steam_api_key:
        try:
            ...
            logger.warning(f"API key {api_key} encountered an error: {str(exc)}")
...
async def get_user_data(
    ...
    # 僕らを照らす光があるよ<br>今日もいっぱい<br>明日もいっぱい 力を出しきってみるよ\t\t\t\t\t\t\t</div>
    ...
    # avatar \t<link rel="image_src"
    # href="https://avatars.akamai.steamstatic.com/3ade30f61c3d2cc0b8c80aaf567b573cd022c405_full.jpg">
